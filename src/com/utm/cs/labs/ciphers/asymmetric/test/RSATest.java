package com.utm.cs.labs.ciphers.asymmetric.test;
...
import static com.utm.cs.labs.ciphers.asymmetric.rsa.RSA.stringToAscii;
...
public class RSATest {
    ...
    public void decrypt() {
        ...
        String encryptedMessage1 = rsa.encrypt(test1);
        assertEquals(rsa.decrypt(new StringBuilder(encryptedMessage1)), test1);
        String encryptedMessage2 = rsa.encrypt(test2);
        assertEquals(rsa.decrypt(new StringBuilder(encryptedMessage2)), test2);
        String encryptedMessage3 = rsa.encrypt(test3);
        assertEquals(rsa.decrypt(new StringBuilder(encryptedMessage3)), test3);
    }
